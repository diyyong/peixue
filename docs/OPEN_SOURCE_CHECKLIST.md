...
- [ ] **确认版权归属**：你有权以所选许可证发布全部代码、图标、图片、字体、题目示例和提示词
- [ ] **确认许可证选择**：当前默认是 MIT；如希望网络部署的修改也公开，应在首次发布前评估 AGPL-3.0
...
> 本地源码、构建和自动检查已经补齐。仍需维护者确认版权/许可证、轮换凭据并完成真实 Docker 端到端验收；仓库公开并有可核验的 Release 与维护记录后再提交 Codex for OSS 申请更有说服力。
...
- [ ] 仓库已公开，源码可构建，License 可被 GitHub 识别
